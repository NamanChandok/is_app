    ...
    <>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div className="text-[#AFAFAF] text-sm font-medium flex items-center gap-2">
        ...
        <div className="flex items-center gap-1">
          <div className="bg-[#f6f6f6] p-3 flex items-center gap-3 rounded-md">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
          ...
          >
            ...
            <div className="absolute top-0.5 right-0.5 border-2 border-white bg-[#4B6A4F] flex items-center justify-center text-[#f6f6f6] group-hover:border-[#EEEEEE] rounded-full text-xxs font-medium w-4 h-4">
              2
            </div>
          </button>
          <a
            href="#"
            className="flex gap-2 items-center pr-3 pl-2 py-1.5 cursor-pointer hover:bg-[#EEEEEE] rounded-md"
          >
            <img src="/profile.jpg" className="w-7 h-7 rounded-full" />
            <div className="h-7 grid -space-y-0.5 w-14">
              <p className="text-xs leading-none">John Doe</p>
              <small className="text-[#757575] text-xxs truncate">john.doe@example.com</small>
            </div>
          </a>
        </div>
      </nav>
      ...
      <footer className="fixed inset-x-0 bottom-0 inset-shadow-px-t bg-white text-[#757575] pl-8 pr-4 pt-1 font-medium flex">
        <a
          href="#"
          className="px-4 py-2.5 bg-[#E8F0E9] border-t-2 border-[#4B6A4F] text-[#3E5741] font-semibold"
        >
          All Orders
        </a>
